...
import controller.main.PodcasterVBoxController;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            for (int i=0; i<podcasterName.length; i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/view/main/PodcasterVBox.fxml"));
            ...
            for (int i=0; i<categoryNameStr.length; i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("/view/search/categoryVBox.fxml"));
